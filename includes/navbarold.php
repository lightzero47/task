                    ...
                    <div class="header-left">
                        ...
                        <!-- <div class="dropdown for-notification">
                            ...
                            <div class="dropdown-menu" aria-labelledby="notification">
                                ...
                                <a class="dropdown-item media" href="#"><i class="fa fa-check"></i><p>Server #1 overloaded.</p></a>
                                <a class="dropdown-item media" href="#"><i class="fa fa-info"></i><p>Server #2 overloaded.</p></a>
                                <a class="dropdown-item media" href="#"><i class="fa fa-warning"></i><p>Server #3 overloaded.</p></a>
                            </div>
                        </div> -->
